<template>
  ...
  >
    ...
    <v-row>
      <v-col cols="12" md="3">
        <div class="text-body-1 black--text mb-2" v-text="$t('type')"></div>
        <v-select
          :items="typeItems"
          v-model="type"
          item-value="value"
      ...
      <v-col cols="12" md="3" v-if="type == 'todo'">
        <div class="text-body-1 black--text mb-2" v-text="$t('ticket')"></div>
        <search
          v-model="ticket"
          item-text="code"
          item-value="id"
    ...
    <v-row>
      <v-col cols="12" md="3">
        <div class="text-body-1 black--text mb-2" v-text="$t('endType')"></div>
        <v-select
          :items="endTypeItems"
          v-model="endType"
          item-value="value"
...
export default {
  ...
  methods: {
    ...
    resetForm() {
      this.$v.$reset();
      this.$store.dispatch(`dailyReport/reset`);
    }
  },
