...
/**
 * Class PotentialAgentController
 * @package App\Http\Controllers\Api
 * @author Kamal Mohammed
 */
class PotentialAgentController extends Controller
{
    use TCompanyPerson;
    /**
    ...
    public function store(Request $request)
    {
        ...
        try
        {
            ...
            {
                return $this->createNewCompanyPerson($data,"potentialAgent");
            }
            else
            {
                $cid = $data['company_person_id'];
                return $this->updateOthersOrAddType($data, $cid,"potentialAgent");
            }
        }
        catch(\Exception $ex)
        {
